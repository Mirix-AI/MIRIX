...
class MetaClawLauncher:
    ...
    async def _start_skills_only(self, cfg):
        ...
        if cfg.use_skills:
            _sp = os.environ.get("METACLAW_SKILLS_PROVIDER", "metaclaw")  # [D6 mod 2026-05-28]
            if _sp == "metaclaw":  # [D6 mod 2026-05-28]
                Path(cfg.skills_dir).mkdir(parents=True, exist_ok=True)  # [D6 mod 2026-05-28]
                skill_manager = SkillManager(  # [D6 mod 2026-05-28]
                    skills_dir=cfg.skills_dir,  # [D6 mod 2026-05-28]
                    retrieval_mode=cfg.retrieval_mode,  # [D6 mod 2026-05-28]
                    embedding_model_path=cfg.embedding_model_path,  # [D6 mod 2026-05-28]
                    task_specific_top_k=cfg.task_specific_top_k,  # [D6 mod 2026-05-28]
                )  # [D6 mod 2026-05-28]
                logger.info("[Launcher] SkillManager loaded: %s skills", skill_manager.get_skill_count())  # [D6 mod 2026-05-28]
            elif _sp == "stub":  # [D6 mod 2026-05-28]
                from evals.metaclaw.mirix_adapters._stub import StubSkillsAdapter  # [D6 mod 2026-05-28]
                skill_manager = StubSkillsAdapter()  # [D6 mod 2026-05-28]
                logger.info("[Launcher] StubSkillsAdapter active (METACLAW_SKILLS_PROVIDER=stub)")  # [D6 mod 2026-05-28]
            elif _sp == "mirix":  # [D6 mod 2026-05-28]
                from evals.metaclaw.mirix_adapters.skills_adapter import MirixSkillsAdapter  # [D6 mod 2026-05-28]
                skill_manager = MirixSkillsAdapter(  # [D6 mod 2026-05-28]
                    base_url=os.environ["METACLAW_MIRIX_BASE_URL"],  # [D6 mod 2026-05-28]
                    user_id=os.environ["METACLAW_MIRIX_USER_ID"],  # [D6 mod 2026-05-28]
                    top_k=cfg.task_specific_top_k or 6,  # [D6 mod 2026-05-28]
                )  # [D6 mod 2026-05-28]
                logger.info(  # [D6 mod 2026-05-28]
                    "[Launcher] MirixSkillsAdapter active (base=%s user=%s top_k=%s)",  # [D6 mod 2026-05-28]
                    os.environ["METACLAW_MIRIX_BASE_URL"],  # [D6 mod 2026-05-28]
                    os.environ["METACLAW_MIRIX_USER_ID"],  # [D6 mod 2026-05-28]
                    cfg.task_specific_top_k or 6,  # [D6 mod 2026-05-28]
                )  # [D6 mod 2026-05-28]
            else:  # [D6 mod 2026-05-28]
                raise ValueError(f"METACLAW_SKILLS_PROVIDER={_sp!r} not in {{metaclaw, mirix, stub}}")  # [D6 mod 2026-05-28]

        skill_evolver: Optional[SkillEvolver] = None
        _ep = os.environ.get("METACLAW_EVOLVER_PROVIDER", "metaclaw") if cfg.enable_skill_evolution and skill_manager is not None else None  # [D6 mod 2026-05-28]
        if cfg.enable_skill_evolution and skill_manager is not None:
            try:
                if _ep == "metaclaw":  # [D6 mod 2026-05-28]
                    skill_evolver = SkillEvolver(  # [D6 mod 2026-05-28]
